...
public class UserController : Controller
{
    ...
    [HttpPost]
    public async Task<APIResponseResult<UserModel>> LoginUser([FromBody] LoginModel model)
    {
    ...
    [HttpPost]
    public async Task<APIResponseResult<string>> SignUpUser([FromBody] RegisterModel model)
    {
